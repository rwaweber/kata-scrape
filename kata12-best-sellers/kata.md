...
A GedankenKata this week: no code needed (although writing short prototypes
might help you come to a conclusion).

Say you’re writing code for a high-colume online site that sells things
(something like Amazon). Your site is wildly popular, and you sell millions of
items each day.
...
database vs. in-memory solutions, data structures that allow aging, time-space
tradeoffs, and the like.

Posted by Dave Thomas (@PragDave) Dec 18th, 2013

[Tweet](http://codekata.com//twitter.com/share)

[« Kata13: Counting Code Lines](http://codekata.com/kata/kata13-counting-code-
lines/ "Previous Post: Kata13: Counting Code Lines") [Kata11: Sorting it Out
»](http://codekata.com/kata/kata11-sorting-it-out/ "Next Post: Kata11: Sorting
it Out")
